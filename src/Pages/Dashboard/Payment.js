...
const stripePromise = loadStripe('pk_test_51L43dfGgmy1kWOC8dtDwkCEeaijq6wRdTPnj4bZ0TdiRHuqjRTa2VaWmG7gSOMEeXX92KkuDmM17tYbEzMdh2YeV004r2r5mbJ');

const Payment = () => {

    const { paymentId } = useParams();

    const { data: order, isLoading, error } = useQuery(['orders', paymentId], () => fetch(`https://thawing-thicket-95189.herokuapp.com/orders/${paymentId}`, {
