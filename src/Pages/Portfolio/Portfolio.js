    ...
    return (
        <>
            ...
            <div>
                ...
                <div className=''>
                    <h3 className='text-2xl text-center text-transparent bg-clip-text bg-gradient-to-br from-accent to-secondary mt-3'>MD Raihanuzaman Faruk</h3>
                    <div className='flex flex-col justify-center items-center mb-6'>
                        <h3 className='text-lg text-sky-500'>raihanuzamanfaruk@gmail.com</h3>
                        <Link to='https://www.linkedin.com/in/abduss-sobhan/' class="text-lg btn-active btn-info btn-link">Linkedin profile</Link >
                        <Link to='http://.web.app/' class="text-lg btn-active btn-info btn-link">Portfolio</Link >
                    </div>
